                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" {{ !$data->main_menu_id ? 'checked' : '' }}
                                    type="radio" name="level_menu" id="inlineRadio1" value="main_menu">
                                <label class="form-check-label" for="inlineRadio1">Main menu</label>
                            </div>
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" {{ $data->main_menu_id ? 'checked' : '' }}
                                    type="radio" name="level_menu" id="inlineRadio2" value="sub_menu">
                    ...
                    <div id="main_menu_wrapper" class="col-md-6 {{ !$data->main_menu_id ? 'd-none' : '' }}">
                        <div class="mb-3">
                            ...
                            <select class="form-select form-select-sm mb-3" name="main_menu"
